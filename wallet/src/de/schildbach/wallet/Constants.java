...
public final class Constants {
    ...
    public static final int PEER_DISCOVERY_TIMEOUT_MS = 5 * (int) DateUtils.MINUTE_IN_MILLIS;
    public static final int PEER_TIMEOUT_MS = 15 * (int) DateUtils.MINUTE_IN_MILLIS;
